...
public class MovieConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Movie movie1 = new Movie("Avengers Endgame", 2.26, 5.99, "After the devastating events of Avengers: Infinity War (2018), the universe is in ruins...", "https://www.youtube.com/watch?v=TcMBFSGVi1c","josa",category1);
        Movie movie2 = new Movie("Avengers Infinity War", 2.25, 5.99, "A despot of intergalactic infamy, his goal is to collect all six Infinity Stones, artifacts of unimaginable power, and use them to inflict his twisted will on all of reality.", "https://www.youtube.com/watch?v=6ZfuNTqbHE8","omcs",category2);
        Movie movie3 = new Movie("Titanic", 2.11, 3.99, "The movie is about the 1912 sinking of the RMS Titanic.", "https://www.youtube.com/watch?v=kVrqfYjkTdQ","lmamo",category3);
        Movie movie4 = new Movie("Despicable me", 3.00, 7.99, "When a criminal mastermind uses a trio of orphan girls as pawns for a grand scheme, he finds their love is profoundly changing him for the better. ", "https://www.youtube.com/watch?v=sUkZFetWYY0","usbis",category4);
